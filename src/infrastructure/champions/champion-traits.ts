...
/**
 * Dataset curado de metadatos por campeón para el análisis de ARAM.
 *
 * Es un punto de partida amplio pero no exhaustivo; los campeones ausentes se
 * tratan como "desconocidos" y se informan aparte. La intención es reemplazar o
 * complementar esta seed más adelante con una fuente derivada de Data Dragon
 * (nombres + tags + info de daño) más overrides curados para los rasgos finos.
 *
 * championId = key numérico de Riot / Data Dragon.
 */
...
/** ChampionTraitProvider basado en la seed curada. */
